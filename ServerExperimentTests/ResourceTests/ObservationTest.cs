...
namespace ServerExperimentTests.ResourceTests
{
    ...
    public class ObservationTest
    {
        ...
        public void TestCreate()
        {
            ...
            var response2 = ObservationController.Create(fhirobservation2, "application/xml+FHIR", true);
        ...
        public void TestUpdate()
        {
            ...
            var response4 = ObservationController.Update(fhirobservation4, 2, "application/xml+FHIR", true);
